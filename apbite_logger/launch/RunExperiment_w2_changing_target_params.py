...
if __name__ == "__main__":
    ...
    w=0
    #Two settings of the obstacles
    while w < 5 and exit_status == 0:#repet for 3 diferent obstacle settings
        ...
        create_world_command = "python random_obstacles.py batch"+str(arg_batch_number)+" "+arg_world +" "+str(arg_serial_num)
        ...
        while i < NUM + 1 and exit_status == 0:
            ...
            while j < 8 and exit_status == 0:
                ...
                arg_secs_to_miss_KnowsTargetLocation = str(j*1.0)
