...
if __name__ == "__main__":
    ...
    w = 0
    while w < 2 and exit_status == 0:  # repet for 2 diferent obstacle settings
        ...
        fb.close()
        arg_serial_num = w
        create_world_command = "python random_obstacles_w1.py batch" + str(arg_batch_number) + " " + arg_world + " " + str(
            arg_serial_num)
        ...
        while i < NUM+1 and exit_status==0:
            ...
            while j < 7 and exit_status == 0:
                ...
                params = params + " world" + str(
                    arg_world) + ":=true"  # This parameter detarmins which world will be launched
