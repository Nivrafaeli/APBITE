...
if __name__ == "__main__":
    ...
    w=0
    while w < 5 and exit_status == 0:#repet for 2 diferent obstacle settings
        ...
        create_world_command = "python random_obstacles_w4.py batch"+str(arg_batch_number)+" "+arg_world +" "+str(arg_serial_num)
